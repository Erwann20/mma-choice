...
export { SEQUELAE, SEQUELA_LABEL, activeSequelae, hasChronicInjury, acquireSequela } from './injuries'
export { MENTOR_FLAG, SIGNATURE_LABEL, SIGNATURE_BONUS, signatureTactic, mentorFlag } from './coaching'
